...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application': 'IOSIPAD\t7.14.0\tiPhone OS\t10.12.0', 'X-Line-Access': self.authToken, 'User-Agent': 'Line/7.14.0 IOS\t7.14.0\tiPhone OS\t10.12.0'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'IOSIPAD\t7.14.0\tiPhone OS\t10.12.0', 
              'X-Line-Access': self.authToken, 
              'User-Agent': 'Line/7.14.0 IOS\t7.14.0\tiPhone OS\t10.12.0'
   }
